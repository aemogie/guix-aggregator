...
#+HTML_HEAD: <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/water.css@2/out/water.css" />
...
I can't think of a better setup than using Emacs, with good paren matching, smartparens, paredit if you like. Then you can use a nice Geiser install or as I do, Arei and Ares on Emacs. I usually like to use watchexec as well for hot reloading.
