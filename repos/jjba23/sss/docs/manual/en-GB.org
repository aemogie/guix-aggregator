...
For example if you want to set your own system language, and thus not use ~sss-default-lang~, you need to define and export a ~sss-override-lang~ with a compatible value. This logic applies to all settings in ~src/sss/defaults.scm~.
...
(define-module (sss overrides)
  ...
  #:export (sss-override-extra-packages sss-override-filesystems
                                        sss-override-hostname
                                        sss-override-hyprland-extra-startups
                                        sss-override-hyprland-monitors
                                        sss-override-keyboard-layout
                                        sss-override-lang
                                        sss-override-mapped-devices
                                        sss-override-palette
                                        sss-override-subgids
                                        sss-override-subuids
                                        sss-override-sudoers
                                        sss-override-users
                                        sss-override-timezone))

(define sss-override-sudoers
...
(define sss-override-subgids
  (list (subid-range (name "joe"))
        (subid-range (name "manon"))))

(define sss-override-subuids
  (list (subid-range (name "joe"))
        (subid-range (name "manon"))))
...
(define sss-override-users
  (list sss-joe-user-account sss-manon-user-account))

;; system language
(define sss-override-lang
  "nl_NL")

;; system timezone
(define sss-override-timezone
  "Europe/Amsterdam")

;; system keyboard layout
(define sss-override-keyboard-layout
  "us")

;; system hostname
(define sss-override-hostname
  "gnu-framework")

(define sss-override-extra-packages
  '("amd-microcode" "amdgpu-firmware" "prismlauncher"))

(define sss-override-hyprland-extra-startups
  '("sudo warp-svc" "sudo mkdir -p /usr/share/warp/images"
    "sleep 1 && warp-taskbar"))

(define sss-override-palette
  'sss-palette-ef-dream)

(define sss-override-mapped-devices
  (list (mapped-device
          (source (uuid "e84af212-b13b-4163-9165-57bd6f1b787d"))
          (target "rootfs")
          (type luks-device-mapping))))

(define sss-override-filesystems
  (list (file-system
          (mount-point "/")
          (device "/dev/mapper/rootfs")
          (type "btrfs")
          (dependencies sss-override-mapped-devices))
        (file-system
...
(define sss-override-hyprland-monitors
...
While unlikely, it's possible that some packages fail to install/build for your setup. I would encourage to temporarily comment those out of the configuration (likely at ~src/sss/packages.scm~) and try again. After a working SSS setup, you can uncomment them and try again.
...
* Some relevant Emacs keybindings
