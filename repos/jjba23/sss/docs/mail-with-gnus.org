...
In contrast to my computer, and software that I write, which are organized, structured and neat, my e-mail looks more like Azathoth's wrath was unleashed upon it.
...
(defun w3mext-open-link-or-image-or-url ()
  "Opens the current link or image or current page's uri or any url-like text under cursor in browser."
  (interactive)
  (let* (url)
    (when (or (string= major-mode "w3m-mode") (string= major-mode "gnus-article-mode"))
      (setq url (w3m-anchor))
