#+TITLE: Qutebrowser settings @lynn
#+PROPERTY: header-args :tangle ./config.py
#+auto_tangle: t
Config file:
Referencing https://codeberg.org/agx-r/agx-guix-home/src/branch/main/dotfiles/qutebrowser/config.py
#+begin_src python
...
#+end_src
The page we see at the start!
#+begin_src html :tangle ./start.html
  <!DOCTYPE html>
  <html>
    <head>
      <meta charset="utf-8">
...
#+end_src
#+begin_src python :tangle ./gruvbox.py
