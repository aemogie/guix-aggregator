  ...
  (jack-html
   `((:center
      ...
      (:a (@ :href "https://www.gnu.org/software/emacs")
          (:img (@ :alt "emacs badge" :src ,(my/get-up-directory level "static/images/badges/emacs.gif"))))
      (:a (@ :href "https://guix.gnu.org")
          (:img (@ :alt "guix badge" :src ,(my/get-up-directory level "static/images/badges/gnu-guix-deployed.svg"))))
      (:a (@ :href "https://scheme.org")
          (:img (@ :alt "lisp badge" :src ,(my/get-up-directory level "static/images/badges/lisp.png"))))
      (:a (@ :href "https://en.wikipedia.org/wiki/IPv6")
          (:img (@ :alt "ipv6 badge" :src ,(my/get-up-directory level "static/images/badges/ipv6.gif"))))
      (:a (@ :href "https://xmpp.org/")
          (:img (@ :alt "xmpp badge" :src ,(my/get-up-directory level "static/images/badges/xmpp.gif"))))
      (:a (@ :href "https://keepassxc.org/")
          (:img (@ :alt "keepassxc badge" :src ,(my/get-up-directory level "static/images/badges/keepassxc.gif"))))
      (:a (@ :href "https://wiby.me/")
          (:img (@ :alt "wiby badge" :src ,(my/get-up-directory level "static/images/badges/wiby.gif"))))
      ;; (:a (@ :href "https://250kb.club")
      ;;     (:img (@ :alt "badge: proud member of the 250KB Club" :src ,(my/get-up-directory level "static/images/badges/250kb-badge.png"))))
      ))))
