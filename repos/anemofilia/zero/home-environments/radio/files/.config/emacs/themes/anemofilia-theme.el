...
(custom-theme-set-faces
 ...
 `(vertico-current ((t (:background ,dark-blue :foreground ,white))))

 `(consult-file ((t (:slant italic :weight regular))))
 `(consult-key ((t (:slant italic :weight regular))))
 `(consult-number ((t (:slant italic :weight regular))))

 `(marginalia-mode ((t (:foreground ,light-gray))))
 `(marginalia-documentation ((t (:foreground ,light-gray :slant italic))))
 `(marginalia-file-owner ((t (:slant italic))))
 `(marginalia-size ((t (:foreground ,light-gray :slant italic))))
 `(marginalia-date ((t (:foreground ,light-gray :slant italic))))
 `(marginalia-file-priv-read ((t (:foreground ,light-gray :slant italic))))
 `(marginalia-file-priv-write ((t (:inherit marginalia-file-priv-read))))
 `(marginalia-file-priv-exec ((t (:inherit marginalia-file-priv-read))))
 `(marginalia-file-priv-no ((t (:inherit marginalia-file-priv-read))))
 `(marginalia-file-priv-link ((t (:inherit marginalia-file-priv-read :weight bold))))
 `(marginalia-file-priv-dir ((t (:inherit marginalia-file-priv-read :weight bold))))

 `(aw-leading-char-face ((t (:height 1.2 :background ,blue :foreground ,black :weight bold))))
 `(aw-minibuffer-char-face ((t (:height 1.2 :background ,blue :foreground ,black :weight bold))))

 `(anzu-mode-line ((t (:weight bold))))
 `(anzu-mode-line-no-match ((t (:weight bold))))

 `(which-key-key-face ((t (:inherit default))))
 `(which-key-note-face ((t (:inherit link))))
 ...
 `(org-block-begin-line ((t (:inherit vertico-current))))
 `(org-block-end-line ((t (:inherit vertico-current))))
 ...
 `(match ((t (:inherit cursor))))
 `(info-index-match ((t (:inherit cursor))))
 `(corfu-current ((t (:inherit cursor))))
