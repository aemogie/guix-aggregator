...
(custom-theme-set-faces
 ...
 `(vertico-current ((t (:inherit cursor))))

 `(marginalia-documentation ((t (:slant italic))))
 `(marginalia-file-owner ((t (:slant italic))))
 `(marginalia-size ((t (:slant italic))))
 `(marginalia-date ((t (:slant italic))))
 `(marginalia-file-priv-read ((t (:slant italic))))
