...
-- Menu colours
theme.menu_fg                 = "#FFF"
theme.menu_bg                 = "#232323"
theme.menu_selected_fg        = "#000"
theme.menu_selected_bg        = "#A790D3"
...
theme.trust_fg   = "#009933"
theme.notrust_fg = "#F00"

-- Follow mode hints
theme.hint_font   = "15px monospace, courier, sans-serif"
theme.hint_fg     = "#000"
theme.hint_bg     = "#BBBBBB" --"#FFD17A"
theme.hint_border = "1px #FFD17A"
theme.hint_overlay_bg = "rgba(f,f,f,0.3)" -- "rgba(255,255,153,0.3)"
--theme.hint_overlay_border = "1px dotted #000"
theme.hint_overlay_selected_bg = "rgba(f,f,f,0.3)" --"rgba(0,255,0,0.3)"
